...
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mAnwarKhan.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mAnwarKhan\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : M4_ANWAR_FB_MASTER
\033[1;92m☞ WhatsApp   : 03498940903
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCGW7kjmCvYHe48cMje0OYxQ
...
def login():
	...
	try:
		...
		pwd=getpass.getpass(A + '[♡] ' + R + 'Password : ')
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update M4_ANWAR Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' M4_ANWAR FB Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/M4_ANWAR')
	    os.system('cd $HOME && git clone https://github.com/anwarkhan125/Anwar')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03498940903✓')
	    psb('WellCome To M4_ANWAR')
	    psb('Congratulations M4_ANWAR Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel Anwar Khan✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/M4_ANWAR && python2 B4.py')
	elif bm =='3':
